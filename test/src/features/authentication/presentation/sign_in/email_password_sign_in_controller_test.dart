...
void main() {
  const testEmail = 'nono@gmail.com';
  const testPassword = '1234';

  group('submit', () {
    test('''
    Given formTyper is signIn
    When signInWithEmailandPssword succeds
    Then return tru
    ...
    test(
      '''
    Given formTyper is signIn
    When signInWithEmailandPssword fails
    Then return false
  ...
  test(
    '''
    Given formTyper is register
    When createUSerWithEmailAndPassword succeds
    Then return true
    And state is AsyncData
    ''',
    () async {
  ...
  test(
    '''
    Given formTyper is register
    When createUserWithEmailandPssword fails
    Then return false
    And state is AsyncError
    ''',
    () async {
